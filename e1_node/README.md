...
- <a href="#0">Conteúdos do Curso</a>
- <a href="#1">Getting Started Guide</a>
...
Aprender a definir o que é Node.js, reconhecer quando essa tecnologia deve ser utilizada e ser capaz de começar um projeto simples em Node do zero.
...
<details>
<summary>Definição de Node 🔻</summary>
...
<h3 id="1"><a href="https://nodejs.org/en/docs/guides/getting-started-guide/" target="_blank">🚀 Getting Started Guide</a></h3>

#### 🔶 Executando o app.js

Digite na pasta do projeto:
